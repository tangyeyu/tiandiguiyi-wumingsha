			...
			game.import('character', function () {
				...
				pkg = {
					...
					characterIntro: {
						...
						tdgx_luxun: '名·陆逊。<br>连营：锁定技，失去非使用打出的牌获「谦」；没有手牌时摸至体力上限；出牌阶段开始时按「谦」数摸牌并弃谦；结束阶段视使用打出与弃牌情况摸牌。<br>炽炎：出牌阶段限X次（X为轮次），弃等同体力值的牌造成火焰伤害并可视为使用铁索连环；结束阶段按以此法造成的伤害对连环角色扩大打击。<br>谦逊：锁定技，受伤时按「谦」与体力上限的关系判定摸牌/减伤/免疫。<br>彰才（神威技）：发动后本回合使用牌无次数和距离限制。',
					...
					translate: {
						...
						'tdgx_lukang': '名·陆抗',
						'lx_lianying': '连营',
						'lx_lianying_info': '锁定技，每当你因非使用和打出而失去牌时，你获得一个「谦」标记。当你没有手牌时，你将手牌摸至体力上限。出牌阶段开始时，你摸等同于「谦」数量的牌，并弃置所有的「谦」。结束阶段，若你使用或打出的牌数不大于你的体力值，你摸等同于你弃牌阶段弃置牌数的牌。',
